...
\begin{center}
  ...
  {\color{white!90!gray}\large
    ...
    \quad C.\,J.~Winkleblack \quad W.~Jones \quad N.~Sawant}\\[0.3cm]
  {\color{white!80!gray}\normalsize
    National Renewable Energy Laboratory (NREL) \textemdash{} NatLabRockies}\\[0.4cm]
  \begin{tikzpicture}
...
\begin{tikzpicture}[remember picture, overlay]
  \fill[titleblue]
    ...
    rectangle
    ([xshift=3cm,yshift=3.8cm]current page.south east);
\end{tikzpicture}
...
\begin{columns}[T,totalwidth=\linewidth]
  \begin{column}{0.70\linewidth}
    ...
    {\color{white}\small\raggedright\sloppy
      ...
      \vspace{0.2cm}
      \textbf{GPU implementation \& parallelisation benchmarks:}\;
  ...
  \begin{column}{0.28\linewidth}
    ...
    {\color{white!70!titleblue}\small\raggedright
      \texttt{module load qiskit/aer-gpu}\\[3pt]
      NREL Kestrel \textemdash{} \texttt{qiskit/aer-gpu}\\
      CUDA-Q\,0.14.0\;/\;cuQuantum\,26.3.0\\
      Qiskit\,2.2.3\;/\;mpi4py\,4.1.1\\
      Cray MPICH\,8.1.28\;+\;GTL
    }
  \end{column}
\end{columns}
