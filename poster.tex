...
\newcommand{\theoryblock}[2]{%
  \begin{tcolorbox}[
      ...
      before skip=5pt, after skip=0pt,
  ]#2\end{tcolorbox}}
...
\vspace{0.2cm}
\begin{center}
  \includegraphics[width=\linewidth, height=8cm, keepaspectratio]{qiskit_impl/parallelisation_study.png}
\end{center}
...
\begin{center}
  \includegraphics[width=\linewidth, height=10cm, keepaspectratio]{qiskit_impl/parallelisation_mgpu_comparison.png}
\end{center}
